...
xttobit prev_dev_MNEs_excl_col_pow voice_accountability pol_stab_abs_violence gov_effectiveness reg_quality rule_of_law control_corruption gni_capita roads_paved_pct phones_capita geographic_proximity colonial_link, ll(0) ul(100) re

* Store the results of the random effects model
estimates store re_model

* Estimating a pooled Tobit model
tobit prev_dev_MNEs_excl_col_pow voice_accountability pol_stab_abs_violence gov_effectiveness reg_quality rule_of_law control_corruption gni_capita roads_paved_pct phones_capita geographic_proximity colonial_link, ll(0) ul(100)
