...
egen row_missing = rowmiss(perc_emnes_excl_nat_res c1 c2 c3 c4 c5 c6 gni_per_capita perc_roads_paved phones_per_1000 geographic_proximity colonial_link)
...
xttobit perc_emnes_excl_nat_res voice_and_accountability political_stability_and_absence_of_violence government_effectiveness regulatory_quality rule_of_law control_of_corruption gni_per_capita roads_paved_pct phones_per_1000 geographic_proximity colonial_link, ll(0) ul(100) re

* Store the results of the random effects model
estimates store re_model

* Estimating a pooled Tobit model
tobit perc_emnes_excl_nat_res voice_and_accountability political_stability_and_absence_of_violence government_effectiveness regulatory_quality rule_of_law control_of_corruption gni_per_capita roads_paved_pct phones_per_1000 geographic_proximity colonial_link, ll(0) ul(100)
