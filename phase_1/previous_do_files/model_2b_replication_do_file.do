...
egen row_missing = rowmiss(perc_developing_excl_nat_res c1 c2 c3 c4 c5 c6 gni_per_cap perc_roads_paved phones_per_1000 mne_from_bordering_country mne_from_former_col_power)
...
xttobit prev_dev_MNEs_excl_nat_res voice_accountability pol_stab_abs_violence gov_effectiveness reg_quality rule_of_law control_corruption gni_capita roads_paved_pct phones_capita geographic_proximity colonial_link, ll(0) ul(100) re

* Store the results of the random effects model
estimates store re_model

* Estimating a pooled Tobit model
tobit prev_dev_MNEs_excl_nat_res voice_accountability pol_stab_abs_violence gov_effectiveness reg_quality rule_of_law control_corruption gni_capita roads_paved_pct phones_capita geographic_proximity colonial_link, ll(0) ul(100)
